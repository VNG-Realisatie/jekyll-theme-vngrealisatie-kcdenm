...
Om de structuur van het theme en navigatie van de verschillende kenniscentra geen geweld aan te doen is besloten voorlopig een eigen theme te 
hanteren voor kenniscentrum Data en Monitoring. Op deze manier kunnen zaken als toplevel navigatie en kenniscentrum specifieke onderdelen beter 
gescheiden en onderhouden worden.

Wel dient nog een verbinding tussen de verschillende sites op kenniscentrum niveau gemaakt te worden.
